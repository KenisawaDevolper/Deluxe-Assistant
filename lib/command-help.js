const commandHelp = [
    ...
    },
    {
        ...
        description: 'Descarga automáticamente enlaces de YouTube y TikTok sin necesidad de comandos.',
        usage: '.autodownload on|off',
        examples: ['.autodownload on', '.autodownload off'],
        access: 'Administrador / Chat'
    },
    {
        category: 'Grupos',
        commands: ['warn'],
